...
const title = "Benefit programs we track | Claimly";
const description =
  "Tax credits, food assistance, healthcare coverage, and housing help — see every federal and state program Claimly checks you against, with rough dollar values.";
